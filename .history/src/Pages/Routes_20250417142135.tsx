...
const AdminDashboard = () => {
  ...
  // Add new state for selected course ID
    ...
    switch (activeComponent) {
      ...
      case 'therapiest':
        ...
        case 'Content Management':
          ...
          case 'Artcicle_management':
            ...
            return <Article_Management selectedCourseId={selectedCourseId} setActiveButton={setActiveButton} />;
          case 'BillingReports':
      ...
      case 'Legal and Complaints':
        ...
        case 'Courses Management':
          // You might want to pass setSelectedCourseId to Course_Management so it can update the selectedCourseId
          return <Course_Management onSelectCourse={setSelectedCourseId} />;
          case 'Settings':
            return <Settings/>
