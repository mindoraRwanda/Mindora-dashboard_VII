...
export default function AdminPatientsList() {
 ...
 const formatTime = (isoString) => {
  ...
  <div className="text-sm text-gray-700">
    Showing {fil.length > 0 ? ((currentPage - 1) * itemsPerPage + 1) : 0} to {Math.min(currentPage * itemsPerPage, filteredtherapists.length)} of {filteredtherapists.length} therapists
  </div>
