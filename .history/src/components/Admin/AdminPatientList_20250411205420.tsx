...
export default function AdminPatientsList() {
 ...
 const formatTime = (isoString) => {
  ...
  <div className="text-sm text-gray-700">
    Showing {filteredPatient.length > 0 ? ((currentPage - 1) * itemsPerPage + 1) : 0} to {Math.min(currentPage * itemsPerPage, filteredPatient.length)} of {filteredPatient.length} therapists
  </div>
