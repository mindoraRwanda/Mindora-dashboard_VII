...
import { Therapist } from "../../Redux/Adminslice/AllAppointment";
...
export default function AdminTherapistList() {
  ...
  const [selectedTherapy, setSelectedTherapy] = useState<Therapist | null>(null);
  ...
  const handleDelete = async (therapyId:number|string) => {
...
const handleUpdate = async (therapist:number|string) => {
            ...
            (therapist) =>
              new Paragraph({
                children: [
                  ...
                  new TextRun({ 
                    text: `\nPhone Number: ${therapist.personalInformation.phoneNumber}`, 
                    break: 1 
                  }),
                  new TextRun({ 
                    text: `\nGender: ${therapist.personalInformation.gender}`, 
...
<div className="flex justify-between items-center mt-4 px-6">
  ...
  <Input
    ...
    onChange={(e) =>
      setSelectedTherapy((prevTherapy: Therapist) => ({
        ...prevTherapy,
        personalInformation: {
