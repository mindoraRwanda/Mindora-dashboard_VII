...
export default function CommunityDetails({visible,communityId}:CommunityDetailsProps) {
    ...
    return(
        <div>
            ...
            <Modal footer={null} onCancel={() => {setShowMembers(false)}} open={visible} width={300} title="Community Details">
            ...
            <Modal footer={null} onCancel={CloseMemberModal} open={showMembers} width={400} title="Members Of Community">
              {status==="loading" ?(
                ...
                {selectedCommunity.members.map((member:Member) => (
