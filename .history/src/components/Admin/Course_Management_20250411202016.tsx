import { Button, Input, message, Modal, Select, Form, Spin, Upload, Card, Tag, Badge, Dropdown, Menu } from "antd";
import { useForm } from "antd/es/form/Form";
import TextArea from "antd/es/input/TextArea";
import { Search, MoreVertical, Plus, Edit3, Trash2, FileText, Filter } from "lucide-react";
import React, { useEffect, useState } from "react";
import { BiBook, BiPlus, BiTime, BiGridAlt, BiListUl } from "react-icons/bi";
...
function Course_Management() {
  ...
  const getCourseIcon = (category) => {
    const icons = {
      "Programming": <FaGraduationCap size={24} className="text-blue-500" />,
      "Data Science": <FaGraduationCap size={24} className="text-green-500" />,
      "Marketing": <FaGraduationCap size={24} className="text-orange-500" />,
      "Artificial Intelligence": <FaGraduationCap size={24} className="text-purple-500" />,
      "Mental Problems": <FaGraduationCap size={24} className="text-red-500" />,
      "Immunity issues": <FaGraduationCap size={24} className="text-yellow-500" />,
      "Family categories": <FaGraduationCap size={24} className="text-cyan-500" />,
      "Relationship": <FaGraduationCap size={24} className="text-pink-500" />
    };
    return icons[category] || <FaGraduationCap size={24} className="text-gray-500" />;
  };
