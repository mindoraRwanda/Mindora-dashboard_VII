  ...
  const handleSave = () => {
    ...
    const validatePasswords = () => {
      if (!oldPassword || !newPassword||!confirmPassword) {
        message.error('All password change Field are required');
        return false;
      }
  ...
  return (
    <div className="space-x-6 mt-8 flex gap-3 flex-col md:flex-row justify-center items-center">
      ...
      <Card className='flex justify-center items-center '>
        ...
        <div>
          <Button type="primary" disabled={isLoading} onClick={handleChangePass(oldPassword,newPassword)}>Update Password</Button>
        </div>
        </div>
      </Card>
    </div>
