...
export default function Settings() {
  ...
  const handleSave =async() => {
    ...
    setIsLoading(true);
    try{
      console.log('Data that are sent to the backend', {UserId,firstName,lastName,email,profileImage:profilePhoto});
      const response= await dispatch(updateProfile({UserId,firstName,lastName,email,profileImage:profilePhoto}));
      ...
      if(updateProfile.fulfilled.match(response)){
        ...
        const errorMessage = response.payload || 'Failed to update profile';
