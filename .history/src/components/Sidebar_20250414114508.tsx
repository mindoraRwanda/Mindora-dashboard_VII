    ...
    <div className="flex flex-col h-full">
      ...
      <nav className="mt-8">
        ...
        {userRole === "therapist" ? (
           ...
           <a onClick={() => setActiveComponent("communit")} className="cursor-pointer flex items-center text-2xl ml-4 my-3 font-semibold text-gray-700 hover:bg-white p-2 rounded-sm transition duration-200">
