...
export default function Communities() {
  const communitiesList = [
    { id: 1, name: "Mental Health Professionals", memberCount: 124, avatar: "https://via.placeholder.com/100" },
    { id: 2, name: "Therapy Techniques", memberCount: 89, avatar: "https://via.placeholder.com/100" },
    { id: 3, name: "Clinical Practice", memberCount: 56, avatar: "https://via.placeholder.com/100" }
  ];
  
  const topicsList = [
    { id: 1, title: "Latest research on CBT", comments: 12, author: "Dr. Smith" },
    { id: 2, title: "Group therapy best practices", comments: 8, author: "Dr. Johnson" },
    { id: 3, title: "Self-care for therapists", comments: 15, author: "Dr. Williams" },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <Card 
            title={
              <div className="flex justify-between items-center">
                <span className="text-purple-700">Discussion Topics</span>
                <Button size="small" icon={<BiEdit />} className="bg-purple-50 text-purple-700">
                  New Topic
                </Button>
              </div>
            } 
          ...
          >
            {topicsList.map(topic => (
              <div key={topic.id} className="border-b border-gray-100 py-3 last:border-b-0">
                <div className="flex justify-between">
                  <Title level={5} className="m-0 text-gray-800">
                    {topic.title}
                  </Title>
                  <Badge count={topic.comments} size="small" className="bg-purple-500" />
                </div>
        ...
        <div className="lg:col-span-2">
          <Card 
            title={
              <div className="flex justify-between items-center">
                <span className="text-purple-700">Discussion: Latest research on CBT</span>
                <Space>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <div className="flex items-baseline">
                    <Text strong className="text-gray-800 mr-2">Dr. Johnson</Text>
                    <Text className="text-xs text-gray-500">3 days ago</Text>
                  </div>
                  <Paragraph className="text-gray-700 mt-1">
                    I've found the recent paper by Coleman et al. very insightful regarding exposure techniques in CBT. Has anyone implemented these methods in their practice?
                  </Paragraph>
                </div>
              </div>
            </div>
