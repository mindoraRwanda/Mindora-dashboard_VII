...
export default function Home  ()  {
  ...
  useEffect(()=>{
    dispatch(getAllPatientOfTherapy(therapistId as ));
  },[dispatch, therapistId])
  ...
  const totalPatientCount=totalPatientData?.count||0;
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 hover:shadow-2xl transition duration-300">
          <div className="flex items-center">
            ...
            <div className="ml-5">
              <h4 className="text-2xl font-semibold text-gray-700">{totalPatientCount}</h4>
