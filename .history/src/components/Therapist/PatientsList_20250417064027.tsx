                  ...
                  <tbody>
                    {invoices.map((invoice, index) => (
                      <tr key={index} className="border-b text-gray-600 flex gap-6">
                        ...
                        <td className="w-2/12 p-2 text-left">{invoice.services[0]?.name || 'N/A'}</td>
                        <td className="w-1/12 p-2 text-left">${invoice.services[0]?.price || 'N/A'}</td>
                        <td className="w-1/12 p-2 text-left">{invoice.status || 'Pend'}</td>
