...
const handleUpdateInvoice = async (invoiceId: any) => {
  ...
  <div className="text-sm text-gray-700">
    Showing {safeFilteredPatientLength  > 0 ? ((currentPage - 1) * itemsPerPage + 1) : 0} to {Math.min(currentPage * itemsPerPage, filteredPatient.length)} of {filteredPatient.length} Patients
  </div>
