    ...
    switch (activeButton) {
      ...
      case "View Plans":{
        ...
        return loading? (
          ...
          <d iv className="bg-white rounded-lg  p-6">
                  ...
                  <div className="flex justify-between">
                    <div>
                      ...
                      <div className="flex gap-4">
                        <p className="text-black text-md my-3 flex gap-2">
                          <strong>Start Time:</strong> <FiClock size={16} className="mt-1"/>{formatTime(item.startDate)}
                        </p>
                        <p className="text-black text-md my-3 flex gap-2">
                          <strong>End Time:</strong> <FiClock size={16} className="mt-1"/>{formatTime(item.endDate)}
                        </p>
                      </div>
                      <p className="text-black text-md my-3">
