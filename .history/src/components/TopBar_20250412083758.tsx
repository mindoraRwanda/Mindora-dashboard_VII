  ...
  return (
   ...
   n        >
          ...
          <div className="flex items-center gap-2  relative">
            ...
            {open && (
            <div className="top-12 absolute bg-white px-5 shadow w-60 rounded-md ">
              <ul>
                {menus.map((menu) =>
                  <li
                  key={menu.label}
                  onClick={(menu.onClick)}
                 className=" text-lg font-semibold text-red-500 cursor-pointer p-1 mt-1 hover:bg-blue-100 rounded">{menu.label}</li>
                )}
              </ul>
            </div>
            )}
